...
def test_rag_system():
    ...
    is_valid, result_signal = data_controller.validate_uploaded_file(file=file_id)

    print(is_valid, result_signal)
    ...
    print("\n--- (Agent Chat) ---")
    question = "what are Key Characteristics of AI Agents?" 
